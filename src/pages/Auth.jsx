  ...
  return (
    <section className="min-h-screen bg-black text-white flex items-center justify-center px-6 relative overflow-hidden">
      ...
      >
        ...
        >
          Welcome to <span className="text-green-400">Apexcify</span>
        </motion.h2>
        ...
        >
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.97 }}
            className="w-full py-3 cursor-pointer bg-green-500 text-black rounded-lg font-medium hover:bg-green-400 transition"
          >
            Login
          </motion.button>
          </Link>
